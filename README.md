...
1. Click the `public > index.html` file. This will display the contents of the file for editing. On lines 6 & 7, add your EU account ID (line 6) and your US account ID (line 7) inside of the single quotation marks. This will allow the code to supply the account IDs to the corresponding script URLS found on lines 11 & 12. And then make sure you save the changes with `CMND + S`. 

![Index script](./readme_pics/indexscript.png)

2. Click the `src > appcuesConfig.js` file. On lines 2 & 3, add your EU account ID (line 2) and your US account ID (line 3) inside of the single quotation marks. Make sure you save the changes with `CMND + S`.

![Switcher snippet](./readme_pics/configscript.png)
